...
objRS("CabinNum") = Request.Form("CabinNum")
objRS("SleepNum") = Request.Form("SleepNum")
objRS("CabinThings") = Request.Form("CabinThings")
objRS("FlickrID") = Request.Form("FlickrID")
...
objRS4("CabinNum") = Request.Form("CabinNum")
objRS4("SleepNum") = Request.Form("SleepNum")
objRS4("CabinThings") = Request.Form("CabinThings")
objRS4("FlickrID") = Request.Form("FlickrID")
