...
SQLString = "Select * FROM tblBoat" + " Order by BoatNme"
...
<table cellpadding="0" cellspacing="0" width="500" bgcolor="#FFFFFF" align="center">
	<tr>
		<td height="20" width="500" align="right" valign="middle" bgcolor="#FFFFFF" class="surTitles2"><a href="newBoat.asp"><strong>Add a New Boat &raquo;</strong></a></td>
	</tr>
</table>
		...
		<td>
			<table cellpadding="0" cellspacing="0" width="500">
				<tr>
					...
					<td height="23" width="100%" class="surHeader" align="left" background="images/header_fill.gif">Edit/Add Boats</td>
				</tr>
			</table>
			<table cellpadding="0" cellspacing="0" width="500" class="surBody">
				<tr>
					...
					<td height="23" width="250" valign="top" align="left" bgcolor="#FFFFFF" style="padding:3px 10px 3px 10px; border-bottom:1px solid #ABABAB; border-top:1px solid #DEDDDD; border-right:1px solid #DEDDDD;"><strong>Boat Name</strong></td>
				...
				<tr>
					...
					<td height="23" width="250" valign="top" align="left" bgcolor="#FFFFFF" style="padding:3px 10px 3px 10px; border-bottom:1px solid #ABABAB; border-top:1px solid #DEDDDD; border-right:1px solid #DEDDDD;"><%= objRS("BoatNme") %></td>
					...
					<td height="23" width="50" valign="top" align="center" bgcolor="#FFFFFF" style="padding:3px 10px 3px 10px; border-bottom:1px solid #ABABAB; border-top:1px solid #DEDDDD;"><a href="editBoat.asp?ID=<%= objRS("ID") %>">Edit&nbsp;&nbsp;<img src="images/edit.gif" alt="" border="0"></a></td>
				</tr>
				<%
				objRS.MoveNext
				Loop
