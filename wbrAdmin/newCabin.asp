		...
		<td>
			...
			<table border="0" width="500" cellpadding="5" cellspacing="1" align="center" bgcolor="C0C0C0" class="surBody">
				...
				<tr>
					...
					<td valign="top" bgcolor="#ffffff"><input type="Text" name="CabinNum" style="WIDTH: 395px;"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td valign="top" bgcolor="#ffffff"><input type="Text" name="SleepNum" style="WIDTH: 395px;"></td>
				</tr>
				<tr>
				...
				<tr>
					<td width="100" valign="top" bgcolor="#ffffff">Main Photo:</td>
				...
				<tr>
					...
					<td width="400" valign="top" bgcolor="#ffffff"><input type="Text" name="FlickrID" style="WIDTH: 395px;"></td>
				</tr>
				<tr>
