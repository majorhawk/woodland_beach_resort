		...
		<td>
			...
			<table border="0" width="500" cellpadding="5" cellspacing="1" align="center" bgcolor="C0C0C0" class="surBody">
				...
				<tr>
					...
					<td width="400" valign="top" bgcolor="#ffffff"><input type="radio" name="display" value="1"<%=iif( objRS3("Display") = 1," checked","")%>>&nbsp;Yes&nbsp;&nbsp;&nbsp;<input type="radio" name="display" value="0"<%=iif( objRS3("Display") = 0," checked","")%>>&nbsp;No</td>
				</tr>
				<tr>
