...
SQLString = "Select * FROM tblCabins where ID = '23'"

SQLString4 = "SELECT * FROM tblCabins INNER JOIN tblRates ON tblCabins.CabinNme = tblRates.Cabin WHERE tblCabins.ID = '23'"
...
<!--#include file="includes/header.asp"-->
								...
								<td valign="top" height="97"><h1 title="The Meeting Room: A place to meet with friends and family."><img src="images/title_meet.gif" width="540" height="97" border="0" alt="The Meeting Room: A place to meet with friends and family."></h1></td>
							</tr>
							<tr> 
								<!-- <td></td> -->
