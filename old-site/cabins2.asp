...
SQLString = "Select * FROM tblCabins where CabinType = '2' and Display = '1' order by CabinOrder"
...
<!--#include file="includes/header.asp"-->
							...
							<tr> 
								...
								<% Do While Not ObjRS.EOF %>
									<table width="480">
										<tr>
											<td width="206" height="131" valign="top" align="center" class="cabinDes"><a href="private.asp?ID=<%= objRS("ID") %>"><img src="images/<%= objRS("MainPhoto") %>" width="206" height="131" border="0"><br>Click to View Cabin</a></td>
