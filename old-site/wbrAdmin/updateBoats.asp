...
Response.Redirect "boats.asp"
End If


Set objRS = Server.CreateObject ("ADODB.Recordset")
objRS.Open "tblBoat", objConn, , adLockOptimistic, adCmdTable

objRS.AddNew


objRS("BoatNme") = Request.Form("BoatNme")
objRS("LongDes") = Request.Form("LongDes")
objRS("BoatRateW") = Request.Form("BoatRateW")
objRS("BoatRateD") = Request.Form("BoatRateD")
...
objRS4.Open "tblBoat", objConn, , adLockOptimistic, adCmdTable
...
objRS4("BoatNme") = Request.Form("BoatNme")
objRS4("BoatRateW") = Request.Form("BoatRateW")
objRS4("BoatRateD") = Request.Form("BoatRateD")
...
SQLStrng3 = "Select * From tblBoat Where ID = " + request.Form("ID")
		...
		<td>
			<table cellpadding="0" cellspacing="0" width="500">
				<tr>
					...
					<td height="23" width="100%" class="surHeader" align="left" background="images/header_fill.gif">Are you sure that you want to delete this Boat?</td>
				</tr>
			</table>
			<table border="0" width="500" cellpadding="5" cellspacing="1" align="center" bgcolor="C0C0C0" class="surBody">
				<tr>
					<td align="center" class="surHeader" bgcolor="#FFFFFF">
						...
						<br>
						<font color="#ff0000"><strong><%=objRS3("BoatNme")%></strong></font>
