...
<!--#include file="includes/header.asp"-->
								...
								<td valign="top" height="97"><h1 title="Private Lake Homes: Find out what your home away from home looks like."><img src="images/title_private.gif" width="540" height="97" border="0" alt="Private Lake Homes: Find out what your home away from home looks like."></h1></td>
							</tr>
							<tr> 
								<!-- <td></td> -->
								<td valign="top" class="body" height="274">
									<table width="480">
										<tr>
											<td width="206" height="131" valign="top" align="center" class="cabinDes"><img src="images/<%= objRS("MainPhoto") %>" width="206" height="131" border="0"><br><img src="images/est_<%= objRS("EST") %>.jpg" border="0"></td>
									...
									<table cellpadding="0" cellspacing="0" border="0" width="480" class="OCStyle2" style="margin-top:3px;">
										...
										<tr>
											...
											<td align="left" class="OCStyle4"><%= objRS4("SMRateW") %></td>
											<td align="left" class="OCStyle4"><%= objRS4("SMRateN") %></td>
										</tr>
										<tr>
											<td height="20" align="left" class="OCStyle4" style="padding-left:30px;" bgcolor="#EAEAEA"><%= season2 %></td>
											<td align="left" class="OCStyle4" bgcolor="#EAEAEA"><%= objRS4("SPRateW") %></td>
											<td align="left" class="OCStyle4" bgcolor="#EAEAEA"><%= objRS4("SPRateN") %></td>
										</tr>
										<tr>
											<td height="20" align="left" class="OCStyle4" style="padding-left:30px;"><%= season3 %></td>
											<td align="left" class="OCStyle4"><%= objRS4("FRateW") %></td>
											<td align="left" class="OCStyle4"><%= objRS4("FRateN") %></td>
										</tr>
									</table>
									</div>
									<br>
