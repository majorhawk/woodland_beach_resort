				...
				<tr>
					<td valign="top" height="100">
						<table cellpadding="0" cellspacing="0" border="0">
							<tr>
								<td><a href="http://www.woodlandbeachresort.com"><img src="images/WBR_Logo.gif" alt="Woodland Beach Resort Logo" width="250" height="100" border="0" title="Woodland Beach Resort Home Page"></a></td>
